...
import cross from '../assests/white-cross.png'
function CarDetails() {
    ...
    return (
        <div>
            <img id='Clogo' src={img1} alt='img1' />
            <div className='box'>
                <div id='imageBoxCarDetail'>
                    <img id='carImage' src={car.image} className='image' />
                </div>
                <div id='detailBox'>
                    <h2>{car.name}</h2>
                    <div id='oneRow1'>
                    ...
                    <h3>Rent Per Day: ₹ {car.rentPerDay}</h3>
            ...
            <div id='carDetailBottom'>
                <h1>Car Details</h1>
                <hr className='carDetailHr'/>
                {car.isBooked ? <button id='NAvail'>Not Available <img src={cross} height='15px' width='15px'/></button> : <button id='Avail'>Available</button>}
